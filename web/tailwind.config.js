...
export default {
    ...
    theme: {
        ...
        boxShadow: {
            ...
            'elevation-4':
                '0px 1px 2px rgba(0, 44, 94, 0.12), 0px 0px 2px rgba(0, 44, 94, 0.15), 0px 14px 28px -14px rgba(0, 44, 94, 0.2)',
            'elevation-5':
                '0px 1px 2px rgba(0, 44, 94, 0.12), 0px 0px 2px rgba(0, 44, 94, 0.15), 0px 21px 42px -21px rgba(0, 44, 94, 0.2)',
